 ...
 * Author: Oscar Mendez
 * Course: COMP-003A
 * Purpose: To replicate lecture activity 5
 */
...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        ...
        /* XML comments are prefixed with three forwards slashes '///'
        ...
        // Note: Method definitions are programmed inside the class { } code block, not inside Maine () {}
        /// <summary>
        ...
        /// <summary>
        /// Method for getting the remainder after dividing two numeric values
        /// </summary>
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
